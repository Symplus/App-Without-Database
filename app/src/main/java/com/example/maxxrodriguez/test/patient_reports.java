...
public class patient_reports extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<Report> arrayOfReports = DoctorHomePageActivity.currentReports;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_patient_reports, menu);
        return true;
    }
